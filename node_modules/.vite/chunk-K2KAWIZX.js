import {
  ...
  splitProps,
  untrack
} from "./chunk-CSWONHLF.js";

// node_modules/solid-js/web/dist/dev.js
var booleans = ["allowfullscreen", "allowpaymentrequest", "async", "autofocus", "autoplay", "checked", "controls", "default", "disabled", "formnovalidate", "hidden", "ismap", "itemscope", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "seamless", "selected", "truespeed"];
var Properties = new Set(["className", "indeterminate", "value", ...booleans]);
var ChildProperties = new Set(["innerHTML", "textContent", "innerText", "children"]);
var Aliases = {
  className: "class",
  htmlFor: "for"
};
var DelegatedEvents = new Set(["beforeinput", "click", "dblclick", "focusin", "focusout", "input", "keydown", "keyup", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "pointerdown", "pointermove", "pointerout", "pointerover", "pointerup", "touchend", "touchmove", "touchstart"]);
...
var $$EVENTS = Symbol("delegated-events");
...
function insertExpression(parent, value, current, marker, unwrapArray) {
  ...
  if (t === "string" || t === "number") {
    ...
    if (sharedConfig.context && current.length)
      return current;
    if (array.length === 0) {
      current = cleanChildren(parent, current, marker);
      if (multi)
...
//# sourceMappingURL=chunk-K2KAWIZX.js.map
